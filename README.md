...
```sh
curl -L -o nomad-oasis.zip "https://github.com/sanbrock/nomad-disctro-all/raw/main/nomad-oasis.zip"
```
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/sanbrock/nomad-disctro-all/manifests/main": unauthorized`
